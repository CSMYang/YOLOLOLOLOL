...
class YOLODetector:
    def __init__(self,
        model_path, config_path, class_name_list=None, mean_rgb=[122.67891434, 116.66876762, 104.00698793],
...
if __name__ == '__main__':
    ...
    model_path = 'data\\training_result\\best_state.pth'
    config_path = "./cfg/yolov1.cfg"
    # GPU device on which yolo is loaded.
    gpu_id = 0

    # Load model.
    yolo = YOLODetector(model_path, config_path, gpu_id=gpu_id, conf_thresh=0.1, prob_thresh=0.1, nms_thresh=0.35)
